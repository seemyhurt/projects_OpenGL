...
int main()
{
    ...
    std::string vePath(PROJECT_NAME);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//получаем позицию uniform переменной и затем отправляем в нее данные матрицы с помощью функции glUniform с постфиксом Matrix4fv
