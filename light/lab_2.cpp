...
// GLFW
#include <glfw3.h>
#include <lab2/lab2_shader.h>	//Заголовочный файл шейдерной программы
#include <lab2/lab2_camera.h>	//Заголовочный файл камеры
#include <glm/glm.hpp>
...
int main()
{
	...
	Shader lightShader("vertex.cpp", "fragment.cpp");
	Shader lampShader("lampVertex.cpp", "lampFragment.cpp");
